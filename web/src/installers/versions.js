...
module.exports.InstallerVersions = {
  kubernetes: [
    ...
    "1.17.3",
    "1.16.4",
    "1.21.1", "1.21.0", "1.20.7", "1.20.6", "1.20.5", "1.20.4", "1.20.2", "1.20.1", "1.20.0", // cron-kubernetes-update-120
  ],
  rke2: [
    "v1.19.7+rke2r1",
    "v1.18.13+rke2r1",
  ...
  contour: ["1.15.1", "1.14.1", "1.14.0", "1.13.1", "1.13.0", "1.12.0", "1.11.0", "1.10.1", "1.7.0", "1.0.1", "0.14.0"], // cron-contour-update
  registry: [
    "2.7.1",
  ],
  prometheus: [
